...
I am a big fan and avid user of R's markdown based packages, rmarkdown and bookdown. I use these types of documents to document my analytical process and to communicate and share my findings. 
...
https://bookdown.org/jakevl/utah-dwq-demo/
...
```
(Source code)[https://github.com/utah-dwq/UtahLakeDataExplorer]
