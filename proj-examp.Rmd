...
I am a big fan and heavy user of the markdown based R packages, rmarkdown and bookdown. I use these markdown and bookdown documents to document my analytical process and to communicate and share my findings. 
Below are a few examples of documents I've generated.

### Salinity in Great Salt Lake
An [analysis of changes in salinity in Great Salt Lake](https://bookdown.org/jakevl/gsl-sac1-figs/){target="_blank"} in response to changes in hydrologic connectivity through a railroad causeway that bisects the lake.
