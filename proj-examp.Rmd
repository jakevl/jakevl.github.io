...
Draft application for analyzing and visualizing water quality data in Utah and generating analytical reports. Currently embedded within the [wqTools package](https://github.com/utah-dwq/wqTools). All data derived from 
the national [Water Quality Portal](https://www.waterqualitydata.us/).  
