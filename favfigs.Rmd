...
This shows the the existence, dissipation, and reformation of a deep brine layer as a result of modifications made to a 
...
A deep brine layer (DBL) was present from 2010-2014 when Gilbert and Gunnison Bays were connected through culverts in the railroad causeway. 
...
Intense thermal stratification of a deep (up to 80 meters) reservoir in Utah, Jordanelle Reservoir.  
...
## Ashley Creek TDS
Spatial variation in total dissolved solids (TDS) in streams in the Ashley Creek watershed, Utah.  
